...
cartApp.controller("cartCtrl", function ($scope, $http){
    ...
    $scope.clearCart = function () {
        $http.delete('/onlineshop-spring-mvc-webapp/rest/cart/'+$scope.cartId).success($scope.refreshCart());
    };
    ...
    $scope.addToCart = function (productId) {
        $http.put('/onlineshop-spring-mvc-webapp/rest/cart/add/'+productId).success(function () {
